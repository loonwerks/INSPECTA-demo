...
#include <sb_queue_SW_UdpFrame_1.h>

//------------------------------------------------------------------------------
// Sender API
//
// See sb_queue_SW_UdpFrame_1.h for API documentation. Only implementation details are documented here.

void sb_queue_SW_UdpFrame_1_init(sb_queue_SW_UdpFrame_1_t *queue) {
...
void sb_queue_SW_UdpFrame_1_Recv_init(
  sb_queue_SW_UdpFrame_1_Recv_t *recvQueue,
  sb_queue_SW_UdpFrame_1_t *queue) {
...
bool sb_queue_SW_UdpFrame_1_dequeue(
  sb_queue_SW_UdpFrame_1_Recv_t *recvQueue,
  sb_event_counter_t *numDropped,
  SW_UdpFrame *data) {

  sb_event_counter_t *numRecv = &recvQueue->numRecv;
  sb_queue_SW_UdpFrame_1_t *queue = recvQueue->queue;
  ...
  // incremented. Thus there are really only (SB_QUEUE_SW_UDPFRAME_1_SIZE - 1)
  // elements in the queue.
  *numDropped = (numNew <= SB_QUEUE_SW_UDPFRAME_1_SIZE - 1) ? 0 : numNew - SB_QUEUE_SW_UDPFRAME_1_SIZE + 1;
...
bool sb_queue_SW_UdpFrame_1_is_empty(sb_queue_SW_UdpFrame_1_Recv_t *recvQueue) {
