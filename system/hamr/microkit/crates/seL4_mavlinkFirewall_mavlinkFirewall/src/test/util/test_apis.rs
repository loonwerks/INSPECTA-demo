...
pub struct PreStateContainer {
  pub api_In0: Option<SW::UdpFrame>,
  pub api_In1: Option<SW::UdpFrame>,
  pub api_In2: Option<SW::UdpFrame>,
  pub api_In3: Option<SW::UdpFrame>
}
...
pub fn put_concrete_inputs(
  In0: Option<SW::UdpFrame>,
  In1: Option<SW::UdpFrame>,
  In2: Option<SW::UdpFrame>,
  In3: Option<SW::UdpFrame>)
{
  put_In0(In0);
  put_In1(In1);
  put_In2(In2);
...
pub fn put_In0(value: Option<SW::UdpFrame>)
{
  *extern_api::IN_In0.lock().unwrap() = value
}

/// setter for IN EventDataPort
pub fn put_In1(value: Option<SW::UdpFrame>)
{
  *extern_api::IN_In1.lock().unwrap() = value
}

/// setter for IN EventDataPort
pub fn put_In2(value: Option<SW::UdpFrame>)
{
  *extern_api::IN_In2.lock().unwrap() = value
}

/// setter for IN EventDataPort
pub fn put_In3(value: Option<SW::UdpFrame>)
{
