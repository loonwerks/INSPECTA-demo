...
pub struct PreStateContainer {
  pub api_EthernetFramesTx0: Option<SW::SizedEthernetMessage>,
  pub api_EthernetFramesTx1: Option<SW::SizedEthernetMessage>,
  pub api_EthernetFramesTx2: Option<SW::SizedEthernetMessage>,
  pub api_EthernetFramesTx3: Option<SW::SizedEthernetMessage>
}
...
pub fn put_concrete_inputs(
  EthernetFramesTx0: Option<SW::SizedEthernetMessage>,
  EthernetFramesTx1: Option<SW::SizedEthernetMessage>,
  EthernetFramesTx2: Option<SW::SizedEthernetMessage>,
  EthernetFramesTx3: Option<SW::SizedEthernetMessage>)
{
...
pub fn put_EthernetFramesTx0(value: Option<SW::SizedEthernetMessage>)
{
  *extern_api::IN_EthernetFramesTx0.lock().unwrap() = value
}

/// setter for IN EventDataPort
pub fn put_EthernetFramesTx1(value: Option<SW::SizedEthernetMessage>)
{
  *extern_api::IN_EthernetFramesTx1.lock().unwrap() = value
}

/// setter for IN EventDataPort
pub fn put_EthernetFramesTx2(value: Option<SW::SizedEthernetMessage>)
{
  *extern_api::IN_EthernetFramesTx2.lock().unwrap() = value
}

/// setter for IN EventDataPort
pub fn put_EthernetFramesTx3(value: Option<SW::SizedEthernetMessage>)
{
