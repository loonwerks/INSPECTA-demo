...
#[cfg(not(test))]
extern "C" {
  fn get_EthernetFramesTx0(value: *mut SW::SizedEthernetMessage) -> bool;
  fn get_EthernetFramesTx1(value: *mut SW::SizedEthernetMessage) -> bool;
  fn get_EthernetFramesTx2(value: *mut SW::SizedEthernetMessage) -> bool;
  fn get_EthernetFramesTx3(value: *mut SW::SizedEthernetMessage) -> bool;
...
pub fn unsafe_get_EthernetFramesTx0() -> Option<SW::SizedEthernetMessage>
{
  unsafe {
    let value: *mut SW::SizedEthernetMessage = &mut SW::SizedEthernetMessage::default();
...
pub fn unsafe_get_EthernetFramesTx1() -> Option<SW::SizedEthernetMessage>
{
  unsafe {
    let value: *mut SW::SizedEthernetMessage = &mut SW::SizedEthernetMessage::default();
...
pub fn unsafe_get_EthernetFramesTx2() -> Option<SW::SizedEthernetMessage>
{
  unsafe {
    let value: *mut SW::SizedEthernetMessage = &mut SW::SizedEthernetMessage::default();
...
pub fn unsafe_get_EthernetFramesTx3() -> Option<SW::SizedEthernetMessage>
{
  unsafe {
    let value: *mut SW::SizedEthernetMessage = &mut SW::SizedEthernetMessage::default();
...
lazy_static::lazy_static! {
  ...
  pub static ref IN_EthernetFramesTx0: Mutex<Option<SW::SizedEthernetMessage>> = Mutex::new(None);
  pub static ref IN_EthernetFramesTx1: Mutex<Option<SW::SizedEthernetMessage>> = Mutex::new(None);
  pub static ref IN_EthernetFramesTx2: Mutex<Option<SW::SizedEthernetMessage>> = Mutex::new(None);
  pub static ref IN_EthernetFramesTx3: Mutex<Option<SW::SizedEthernetMessage>> = Mutex::new(None);
...
#[cfg(test)]
pub fn get_EthernetFramesTx0(value: *mut SW::SizedEthernetMessage) -> bool
{
  unsafe {
...
#[cfg(test)]
pub fn get_EthernetFramesTx1(value: *mut SW::SizedEthernetMessage) -> bool
{
  unsafe {
...
#[cfg(test)]
pub fn get_EthernetFramesTx2(value: *mut SW::SizedEthernetMessage) -> bool
{
  unsafe {
...
#[cfg(test)]
pub fn get_EthernetFramesTx3(value: *mut SW::SizedEthernetMessage) -> bool
{
  unsafe {
