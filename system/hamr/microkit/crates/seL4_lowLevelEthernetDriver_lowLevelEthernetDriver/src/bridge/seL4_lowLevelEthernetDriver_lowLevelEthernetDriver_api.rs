...
verus! {
  ...
  pub trait seL4_lowLevelEthernetDriver_lowLevelEthernetDriver_Get_Api: seL4_lowLevelEthernetDriver_lowLevelEthernetDriver_Api {
    ...
    fn unverified_get_EthernetFramesTx0(
      &mut self,
      value: &Ghost<Option<SW::SizedEthernetMessage>>) -> (res : Option<SW::SizedEthernetMessage>)
      ensures
        res == value@,
    {
  ...
  pub struct seL4_lowLevelEthernetDriver_lowLevelEthernetDriver_Application_Api<API: seL4_lowLevelEthernetDriver_lowLevelEthernetDriver_Api> {
    ...
    pub ghost EthernetFramesTx0: Option<SW::SizedEthernetMessage>,
    pub ghost EthernetFramesTx1: Option<SW::SizedEthernetMessage>,
    pub ghost EthernetFramesTx2: Option<SW::SizedEthernetMessage>,
    pub ghost EthernetFramesTx3: Option<SW::SizedEthernetMessage>,
  ...
  impl<API: seL4_lowLevelEthernetDriver_lowLevelEthernetDriver_Get_Api> seL4_lowLevelEthernetDriver_lowLevelEthernetDriver_Application_Api<API> {
    pub fn get_EthernetFramesTx0(&mut self) -> (res : Option<SW::SizedEthernetMessage>)
      ensures
        old(self).EthernetFramesRx0 == self.EthernetFramesRx0,
        old(self).EthernetFramesRx1 == self.EthernetFramesRx1,
        old(self).EthernetFramesRx2 == self.EthernetFramesRx2,
    ...
    pub fn get_EthernetFramesTx1(&mut self) -> (res : Option<SW::SizedEthernetMessage>)
      ensures
        old(self).EthernetFramesRx0 == self.EthernetFramesRx0,
        old(self).EthernetFramesRx1 == self.EthernetFramesRx1,
        old(self).EthernetFramesRx2 == self.EthernetFramesRx2,
    ...
    pub fn get_EthernetFramesTx2(&mut self) -> (res : Option<SW::SizedEthernetMessage>)
      ensures
        old(self).EthernetFramesRx0 == self.EthernetFramesRx0,
        old(self).EthernetFramesRx1 == self.EthernetFramesRx1,
        old(self).EthernetFramesRx2 == self.EthernetFramesRx2,
    ...
    pub fn get_EthernetFramesTx3(&mut self) -> (res : Option<SW::SizedEthernetMessage>)
      ensures
        old(self).EthernetFramesRx0 == self.EthernetFramesRx0,
        old(self).EthernetFramesRx1 == self.EthernetFramesRx1,
        old(self).EthernetFramesRx2 == self.EthernetFramesRx2,
