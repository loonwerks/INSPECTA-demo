...
extern "C" {
  ...
  fn put_MavlinkOut0(value: *mut SW::UdpFrame) -> bool;
  fn put_MavlinkOut1(value: *mut SW::UdpFrame) -> bool;
  fn put_MavlinkOut2(value: *mut SW::UdpFrame) -> bool;
  fn put_MavlinkOut3(value: *mut SW::UdpFrame) -> bool;
}
...
pub fn unsafe_put_MavlinkOut0(value: &SW::UdpFrame) -> bool
{
  unsafe {
    return put_MavlinkOut0(value as *const SW::UdpFrame as *mut SW::UdpFrame);
  }
}

pub fn unsafe_put_MavlinkOut1(value: &SW::UdpFrame) -> bool
{
  unsafe {
    return put_MavlinkOut1(value as *const SW::UdpFrame as *mut SW::UdpFrame);
  }
}

pub fn unsafe_put_MavlinkOut2(value: &SW::UdpFrame) -> bool
{
  unsafe {
    return put_MavlinkOut2(value as *const SW::UdpFrame as *mut SW::UdpFrame);
  }
}

pub fn unsafe_put_MavlinkOut3(value: &SW::UdpFrame) -> bool
{
  unsafe {
    return put_MavlinkOut3(value as *const SW::UdpFrame as *mut SW::UdpFrame);
  }
}
...
lazy_static::lazy_static! {
  ...
  pub static ref OUT_MavlinkOut0: Mutex<Option<SW::UdpFrame>> = Mutex::new(None);
  pub static ref OUT_MavlinkOut1: Mutex<Option<SW::UdpFrame>> = Mutex::new(None);
  pub static ref OUT_MavlinkOut2: Mutex<Option<SW::UdpFrame>> = Mutex::new(None);
  pub static ref OUT_MavlinkOut3: Mutex<Option<SW::UdpFrame>> = Mutex::new(None);
}
...
#[cfg(test)]
pub fn put_MavlinkOut0(value: *mut SW::UdpFrame) -> bool
{
  unsafe {
...
#[cfg(test)]
pub fn put_MavlinkOut1(value: *mut SW::UdpFrame) -> bool
{
  unsafe {
...
#[cfg(test)]
pub fn put_MavlinkOut2(value: *mut SW::UdpFrame) -> bool
{
  unsafe {
...
#[cfg(test)]
pub fn put_MavlinkOut3(value: *mut SW::UdpFrame) -> bool
{
  unsafe {
