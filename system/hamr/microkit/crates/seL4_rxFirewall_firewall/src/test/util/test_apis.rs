...
/// getter for OUT EventDataPort
pub fn get_MavlinkOut0() -> Option<SW::UdpFrame>
{
  return extern_api::OUT_MavlinkOut0.lock().unwrap().clone()
}

/// getter for OUT EventDataPort
pub fn get_MavlinkOut1() -> Option<SW::UdpFrame>
{
  return extern_api::OUT_MavlinkOut1.lock().unwrap().clone()
}

/// getter for OUT EventDataPort
pub fn get_MavlinkOut2() -> Option<SW::UdpFrame>
{
  return extern_api::OUT_MavlinkOut2.lock().unwrap().clone()
}

/// getter for OUT EventDataPort
pub fn get_MavlinkOut3() -> Option<SW::UdpFrame>
{
