...
verus! {
  pub trait seL4_txFirewall_firewall_Api {}

  pub trait seL4_txFirewall_firewall_Put_Api: seL4_txFirewall_firewall_Api {
    #[verifier::external_body]
    fn unverified_put_EthernetFramesTxOut0(
      &mut self,
      value: SW::SizedEthernetMessage)
    {
  ...
  pub trait seL4_txFirewall_firewall_Get_Api: seL4_txFirewall_firewall_Api {
    #[verifier::external_body]
  ...
  pub trait seL4_txFirewall_firewall_Full_Api: seL4_txFirewall_firewall_Put_Api + seL4_txFirewall_firewall_Get_Api {}

  pub struct seL4_txFirewall_firewall_Application_Api<API: seL4_txFirewall_firewall_Api> {
    pub api: API,
    ...
    pub ghost EthernetFramesTxOut0: Option<SW::SizedEthernetMessage>,
    pub ghost EthernetFramesTxOut1: Option<SW::SizedEthernetMessage>,
    pub ghost EthernetFramesTxOut2: Option<SW::SizedEthernetMessage>,
    pub ghost EthernetFramesTxOut3: Option<SW::SizedEthernetMessage>
  }

  impl<API: seL4_txFirewall_firewall_Put_Api> seL4_txFirewall_firewall_Application_Api<API> {
  ...
  impl<API: seL4_txFirewall_firewall_Get_Api> seL4_txFirewall_firewall_Application_Api<API> {
  ...
  pub struct seL4_txFirewall_firewall_Initialization_Api;
  impl seL4_txFirewall_firewall_Api for seL4_txFirewall_firewall_Initialization_Api {}
  impl seL4_txFirewall_firewall_Put_Api for seL4_txFirewall_firewall_Initialization_Api {}

  pub const fn init_api() -> seL4_txFirewall_firewall_Application_Api<seL4_txFirewall_firewall_Initialization_Api> {
    return seL4_txFirewall_firewall_Application_Api {
      api: seL4_txFirewall_firewall_Initialization_Api {},
  ...
  pub struct seL4_txFirewall_firewall_Compute_Api;
  impl seL4_txFirewall_firewall_Api for seL4_txFirewall_firewall_Compute_Api {}
  impl seL4_txFirewall_firewall_Put_Api for seL4_txFirewall_firewall_Compute_Api {}
  impl seL4_txFirewall_firewall_Get_Api for seL4_txFirewall_firewall_Compute_Api {}
  impl seL4_txFirewall_firewall_Full_Api for seL4_txFirewall_firewall_Compute_Api {}

  pub const fn compute_api() -> seL4_txFirewall_firewall_Application_Api<seL4_txFirewall_firewall_Compute_Api> {
    return seL4_txFirewall_firewall_Application_Api {
      api: seL4_txFirewall_firewall_Compute_Api {},
