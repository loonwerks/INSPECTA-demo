...
pub fn get_EthernetFramesTxOut0() -> Option<SW::SizedEthernetMessage>
{
  return extern_api::OUT_EthernetFramesTxOut0.lock().unwrap().clone()
}

/// getter for OUT EventDataPort
pub fn get_EthernetFramesTxOut1() -> Option<SW::SizedEthernetMessage>
{
  return extern_api::OUT_EthernetFramesTxOut1.lock().unwrap().clone()
}

/// getter for OUT EventDataPort
pub fn get_EthernetFramesTxOut2() -> Option<SW::SizedEthernetMessage>
{
  return extern_api::OUT_EthernetFramesTxOut2.lock().unwrap().clone()
}

/// getter for OUT EventDataPort
pub fn get_EthernetFramesTxOut3() -> Option<SW::SizedEthernetMessage>
{
